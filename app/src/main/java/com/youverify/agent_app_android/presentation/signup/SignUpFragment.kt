...
class SignUpFragment : Fragment(R.layout.fragment_sign_up) {
    ...
    private lateinit var stateOfResidenceField: AutoCompleteTextView
    ...
    override fun onCreateView(
        ...
        phoneNumberField = binding.phoneNumField
        emailAddressField = binding.emailField
        stateOfResidenceField = binding.stateOfResidenceInput
        passwordField = binding.passwordField
        confirmPassField = binding.confirmPassField
                ...
                signUpViewModel.signUpChannel.collect {
                    when (it) {
                        ...
                        is SignUpViewState.Success -> {
                            progressLoader.hide()
                            signUpSuccessful(it.signUpResponse)
